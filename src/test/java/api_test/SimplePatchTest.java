...
//Patch command is used to update a single field
public class SimplePatchTest {
    ...
    public void updateUserSingleField(){
        ...
        //just updating the job title - not the name
 ...
 * 15:01:18.631 [main] INFO  api_test.SimplePatchTest - ----------------API Test: Update User's single field----------------------
 * {
 *     "job": "Sales Architect",
 *     "updatedAt": "2023-05-10T19:01:28.133Z"
 * }
 * 15:01:22.044 [main] INFO  api_test.SimplePatchTest - ----------------End Test: Update User's single field----------------------
 */

//at 3:02 week 11 rest assured